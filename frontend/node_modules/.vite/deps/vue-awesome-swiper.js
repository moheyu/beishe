...
var Mousewheel = {
  ...
  handle(event) {
    ...
    const data2 = Mousewheel.normalize(e);
...
var Parallax = {
  ...
  setTranslate() {
    ...
    $el.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((index2, el) => {
    ...
    slides.each((slideIndex, slideEl) => {
      ...
      $(slideEl).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((index2, el) => {
  ...
  setTransition(duration = this.params.speed) {
    const swiper = this;
    const { $el } = swiper;
    $el.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each((index2, parallaxEl) => {
...
var Lazy = {
  loadInSlide(index2, loadInDuplicate = true) {
    const swiper = this;
...
// node_modules/vue-awesome-swiper/dist/vue-awesome-swiper.esm.js
init_vue_runtime_esm();
var CoreNames;
(function(CoreNames2) {
...
function getDirective(SwiperClass2, globalOptions) {
  ...
  return {
    ...
    inserted: function(element, binding, vnode) {
      ...
      if (!swiper || swiper.destroyed) {
        swiper = new SwiperClass2(element, swiperOptions);
...
function getSwiperComponent(SwiperClass2) {
  var _a;
  return Vue.extend({
    ...
    methods: {
      ...
      initSwiper: function() {
        this.swiperInstance = new SwiperClass2(this.$el, this.swiperOptions);
...
var SwiperSlideComponent = Vue.extend({
  ...
  methods: {
    update: function() {
      ...
      if (parent2[ComponentPropNames.AutoUpdate]) {
        (_a = parent2 === null || parent2 === void 0 ? void 0 : parent2.swiperInstance) === null || _a === void 0 ? void 0 : _a.update();
      }
    }
  },
  mounted: function() {
...
var getInstaller = function(SwiperClass2) {
  var install2 = function(Vue2, globalOptions) {
    if (install2.installed) {
      return;
    }
    var SwiperComponent = getSwiperComponent(SwiperClass2);
    if (globalOptions) {
    ...
    Vue2.directive(CoreNames.SwiperDirective, getDirective(SwiperClass2, globalOptions));
    install2.installed = true;
  };
  return install2;
};
function exporter(SwiperClass2) {
  var _a;
  return _a = {
    version: "4.1.1",
    install: getInstaller(SwiperClass2),
    directive: getDirective(SwiperClass2)
  }, _a[CoreNames.SwiperComponent] = getSwiperComponent(SwiperClass2), _a[CoreNames.SwiperSlideComponent] = SwiperSlideComponent, _a;
}
var VueAwesomeSwiper = exporter(swiper_esm_bundle_default);
var version = VueAwesomeSwiper.version;
var install = VueAwesomeSwiper.install;
var directive = VueAwesomeSwiper.directive;
var Swiper2 = VueAwesomeSwiper.Swiper;
var SwiperSlide = VueAwesomeSwiper.SwiperSlide;
var vue_awesome_swiper_esm_default = VueAwesomeSwiper;
export {
  Swiper2 as Swiper,
  SwiperSlide,
  vue_awesome_swiper_esm_default as default,
  directive,
  install,
  version
};
...
vue-awesome-swiper/dist/vue-awesome-swiper.esm.js:
  (*!
  ...
  ***************************************************************************** *)
*/
//# sourceMappingURL=vue-awesome-swiper.js.map
